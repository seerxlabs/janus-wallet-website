  ...
  <div class="footer">
    <div class="follow">
      ...
      <div>
        ...
        <a href="https://github.com/seerxlabs/opensui-website" target="_blank"><img src="@/assets/img/p3.png" alt=""></a>
    ...
    <div class="links">
      ...
      <div class="right">
        <ul>
          <li><b>Resources</b></li>
          <li><a href="https://github.com/seerxlabs/opensui-website" target="_blank">Github</a></li>
        </ul>
        <ul>
          <li><b>Community</b></li>
